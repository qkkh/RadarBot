...
class RadarConfig:
    ...
    # معرف الكاتقوري الخاص بالإحصائيات
...
class AdminDashboard(discord.ui.View):
    ...
    async def refresh_btn(self, i, b):
        ...
        if success: await i.followup.send("✅ تم تحديث الرادار بنجاح", ephemeral=True)
        else: await i.followup.send("❌ فشل التحديث، تأكد من وجود الكاتقوري", ephemeral=True)

    @discord.ui.button(label="تعديل الحالة 🛠️", style=discord.ButtonStyle.secondary, emoji="✍️", row=2)
