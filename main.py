...
class RadarConfig:
    ...
    # الأيدي الخاص بالكاتيقوري لإحصائيات السيرفر
...
class SayModal(discord.ui.Modal, title='إرسال رسالة رادرز المخصصة'):
    message_content = discord.ui.TextInput(
        ...
        placeholder="اكتب رسالتك هنا.. يمكنك النزول لأسطر جديدة",
...
class AdminDashboard(discord.ui.View):
    ...
    async def say_panel_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
        # تم إعادة الزر ليفتح النافذة الخاصة بالرسائل
...
# تم حذف أمر /say المستقل بناءً على طلبك
...
async def panel(interaction: discord.Interaction):
    ...
    if interaction.user.guild_permissions.manage_messages or interaction.user.id == interaction.guild.owner_id:
        embed = discord.Embed(
            ...
            description="مرحباً بك في لوحة التحكم.\n\n- **إطلاق بث**: لإرسال إشارة بث يوتيوب.\n- **إرسال رسالة**: لفتح نافذة كتابة رسالة منسقة.\n- **تعديل الحالة**: لتغيير نشاط البوت.", 
